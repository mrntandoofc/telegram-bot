...
global.botToken = ''; // Bot Token (Get it from BotFather)
global.ownerUsername = 'mouricedevs'; // Owner Username(For Bot Owner)
global.timeZone = 'Africa/Nairobi'; // Your Time Zone
global.ownerId = [5153324742]; // Owner ID(For Bot Owner), You Can Add More than 1
